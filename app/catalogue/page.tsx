    ...
    <div className="min-h-screen py-20">
      <div className="container mx-auto px-4">
        ...
        <motion.div initial="initial" animate="animate" variants={staggerContainer} className="text-center mb-12">
          <motion.div variants={fadeInUp}>
            ...
            <h1 className="text-4xl lg:text-5xl font-bold mb-6">
              Our Complete
              <span className="text-teal-600 dark:text-green-400"> Product Range</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Explore our comprehensive collection of premium PVC pipe clamps, flanges, and fittings designed for
              ...
              <Card className="h-full hover:shadow-lg transition-all duration-300 group">
                ...
                <CardContent className="p-4">
                  ...
                  <div className="space-y-2 mb-4">
                    ...
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-600 dark:text-gray-400">Pressure Rating:</span>
        ...
        {filteredProducts.length === 0 && (
          <motion.div initial="initial" animate="animate" variants={fadeInUp} className="text-center py-12">
